...
if (!isset($_SESSION['uid']) && ($_SESSION['utype'] == "ec")) {
    ...
    $email = $_SESSION['uid'];
    $sql1 = "select coor_name from event_coordinator where email='$email'";
    ...
    <div class="container mt-5">
        ...
        <div class="container mt-3 p-5 border border-primary rounded-3 shadow mb-5 bg-body-tertiary rounded">
            <h3 class='text-secondary'>Co-Ordinator Dashboard</h3>
            <hr>
            <div class="row">
                        ...
                        <div class="card-body">
                            ...
                            <a class="dropdown-toggle btn btn-primary" data-bs-toggle="dropdown" href="#" role="button"
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a class="dropdown-item" href="Approve_Partic.php">Approve Participents</a></li>
                ...
                <div class="col-sm-6">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Manage Winners</h5>
                            <p class="card-text border p-2 rounded"> You can update the Winners and Runners for Event.
                            </p>
                            <a class="btn btn-primary" href="Announce_Res.php">Announce Winners</a>
                        </div>
                    </div>
                </div>
            </div>
